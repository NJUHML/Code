...
import sys
#sys.path.append('/save/users/yangss/code/python_code/nowcasting/EarthFormer_scale_run/earth-forecasting-transformer/src')
...
pytorch_state_dict_name = "earthformer_sevir_3h_mse.pt"
...
class CuboidSEVIRPLModule(pl.LightningModule):
    ...
    def Loss_func(self, preds, targets):
        return self.Loss_func1(preds, targets)
        #return self.Loss_func1(preds, targets)+self.Loss_func2(preds, targets)+1.0*(2 + self.Loss_func3(preds.squeeze(4), targets.squeeze(4)))
    ...
    def forward(self, in_seq, out_seq):
        ...
        loss = self.Loss_func(output, out_seq)
        return output, loss
...
def get_parser():
    ...
    parser.add_argument('--save', default='tmp_sevir_wl', type=str)
...
def main():
    ...
    cfg.datasets_dir = '/share/home/veiga2/yangss/data/SEVIR'
