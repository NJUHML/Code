...
class InterscaleTrans(nn.Module):
    def __init__(self, dim=256,channels = [48,96,192,384], num=1):  # (224*64, 112*128, 56*256, 28*256, 14*512) dim = 256
...
class MultiscaleTrans(nn.Module):
    def __init__(self, size = 384, channels = [1024,512, 1024, 1024]):
    ...
    def forward(self, x):
        feature0, feature1, feature2, feature3 = x
